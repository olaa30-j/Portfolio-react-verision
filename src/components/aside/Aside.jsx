...
const Aside = () => {
    ...
    return (
        <>
        <div className= "toggle" onClick={()=> handleAsideTogle()}><i className={` ${asideToggle? '' : 'fa fa-bars' }`}></i></div>
        <aside ref={asideShow} className='col-lg-3 col-sm-6'>
        <div className= "toggle" onClick={()=> handleAsideTogle()}><i className={` ${asideToggle? 'fa fa-times' : '' }`}></i></div>
